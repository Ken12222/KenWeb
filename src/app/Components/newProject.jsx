...
export default function NewProject() {
  return (
    <div className="w-5/6 mx-auto flex flex-col gap-4 md:flex-row  md:justify-between my-16 bg-gray-700 border border-gray-500 p-8 items-center rounded-3xl">
      <div>
        <p className="text-white text-2xl">Start your next project</p>
        <p className="pt-2">
          Get in touch with me let's start your next project
        </p>
      </div>
      <Link
        href="/contact"
